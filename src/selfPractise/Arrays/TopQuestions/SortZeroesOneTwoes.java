...
public class SortZeroesOneTwoes {
    ...
    public static void main(String arg[]) throws IOException {
        ...
        for (int t = 0; t < testNumber; t++) {
            ...
            SortZeroesOneTwoes sortZeroesOneTwoes =
                    new SortZeroesOneTwoes();
            sortZeroesOneTwoes.sortArrayOfZeroOneTwo(array, numberOfElement);
        }
    }
}
